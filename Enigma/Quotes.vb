...
Module Quotes
    Sub Main()
        Console.WriteLine("GetHSITRI")
        Call GetHSITRI()
        Console.WriteLine("GetShorts")
        Call GetShorts()
        Console.WriteLine("CheckAllEnts")
        Call CheckAllEnts()
        Console.WriteLine("GetQuotesUpdate")
        Call GetQuotesUpdate()
        Console.WriteLine("UpdateFX")
        Call UpdateFX()
        Console.WriteLine("ForeignDivs")
        Call ForeignDivs()
        Console.WriteLine("SetAdjAll")
        Call SetAdjAll()
        'Console.ReadKey()
    End Sub
    Sub ForeignDivs()
